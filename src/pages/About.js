...
export default function About() {
  return (
    <div className="about-container">
      <h1>About Beaver Construction</h1>
      <div className="about-content">
        <div className="about-text">
          <h2>Professional Construction & Interior Designing Company</h2>
          <p>
            BEAVER CONSTRUCTIONS is committed to your comfort from start to finish, every step of the way. 
          ...
          <p>
            BEAVER is committed to build innovative high quality, functional, sustainable and value for money 
